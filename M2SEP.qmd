...
***Usage:*** Utilisée pour traiter le problème de multicollinéarité dans les données. Ajoute une pénalité au carré des coefficients.
***Principe:*** Minimise une somme pondérée des carrés des résidus et des carrés des coefficients.
